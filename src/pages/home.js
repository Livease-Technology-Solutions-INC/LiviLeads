                                                    ...
                                                    <ul class="mainmenu">         
                                                        <li>
                                                            <a class="active" href="#">Home</a>
                                                             <ul class="sub-menu">
                                                                <li><a href="index02.html">Vendor</a></li>
                                                            ...
                                                            <div class="sub-menu megamenu-main megamenu-carousel carousel-nav-text owl-carousel">
                                                                ...
                                                                <a href="#" class="cat-item cat-sopping">
                                                                    ...
                                                                    <div class="cat-content">
                                                                        <div class="cat-content-inner">
                                                                            <p class="listing-no">35</p>
                                                                            <h3 class="title">Documentation-approvals</h3>
                                                                        </div>
                                                                    </div>
                                                                    <div class="cat-content-hover">
                                                                        <div class="content-hover-inner">
                                                                ...
                                                                <a href="#" class="cat-item cat-places">
                                                                    <figure class="cat-thumb">  
                                                                        <img src="assets/images/todo/prooffice.jpg" alt="Thmubnail" /> 
                                                                    </figure>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-10">
                            <div class="frontpage-banner-content text-center text-white">
                                <h1 class="banner-title">Explore a Wide Range of <span> Services</span> For Your Unique Need</h1>
                                <h3 class="banner-subtitle">Our platform connects you with trusted local service</h3>
                                ...
                                <div class="banner-divider">Or Browse Featured Categories</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="section-title text-center">
                                ...
                                <h2 class="title-main">Techniques and Tools for your Growth</h2>
                                <div class="divider">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="todo-item">
                                <div class="todo-thumbnail-area">
                                    ...
                                    <div class="todo-overlay-info">
                                        <div class="todo-type-cat">
                                            <a href="#" class="offer">Wedding</a>
                                            <a href="#" class="nightlife">Portrait</a>
                                        </div>
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="Photography.html">Photography</a></h3>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="todo-item status-closed">
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="Business.html">Business</a></h3>
                                   <div class="todo-price-status">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="todo-item">
                                <div class="todo-thumbnail-area">
                                    ...
                                    <div class="todo-overlay-info">
                                        <div class="todo-type-cat">
                                            ...
                                            <a href="#" class="fitness">samples</a>
                                        </div>
                                        <div class="todo-meta-bottom">
                                            <div class="todo-rating">
                                                <span>4.8</span>19 Ratings
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="listing-details.html">Programming-Tech</a></h3>
                                    <div class="todo-price-status">
                                        <div class="todo-price">$12 - $33</div>
                                        <div class="todo-status">Open Now</div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="todo-item">
                                <div class="todo-thumbnail-area">
                                    ...
                                    <div class="todo-overlay-info">
                                        <div class="todo-type-cat">
                                            <a href="#" class="sale">Cleaning</a>
                                            <a href="#" class="services">Plumbing</a>
                                        </div>
                                        <div class="todo-meta-bottom">
                                            <div class="todo-rating">
                                                <span>4.8</span>19 Ratings
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="listing-details.html">Service Market</a></h3>
                                    <div class="todo-price-status">
                                        <div class="todo-price">$12 - $33</div>
                                        <div class="todo-status">Open Now</div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="todo-item status-closed">
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="listing-details.html">Visaguy</a></h3>
                                    <div class="todo-price-status">
                                        <div class="todo-price">$12 - $33</div>
                                        <div class="todo-status">closed</div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="todo-item">
                                <div class="todo-thumbnail-area">
                                    ...
                                    <div class="todo-overlay-info">
                                        <div class="todo-type-cat">
                                            <a href="#" class="restaurant">Designs</a>
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="listing-details.html">Home Service</a></h3>
                                    <div class="todo-price-status">
                                        <div class="todo-price">$12 - $33</div>
                                        <div class="todo-status">Open Now</div>
                                    </div>
                          ...
                          <div class="col-lg-4 col-md-6">
                            <div class="todo-item status-closed">
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="documentation-approvals.html">Documentation-approvals</a></h3>
                                    <div class="todo-price-status">
                                        <div class="todo-price">$12 - $33</div>
                                        <div class="todo-status">closed</div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="todo-item status-closed">
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="listing-details.html">Electrician</a></h3>
                                    <div class="todo-price-status">
                                        <div class="todo-price">$12 - $33</div>
                                        <div class="todo-status">closed</div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="todo-item">
                                <div class="todo-thumbnail-area">
                                    ...
                                    <div class="todo-overlay-info">
                                        <div class="todo-type-cat">
                                            <a href="#" class="restaurant">Check</a>
                                            <a href="#" class="sale">sale</a>
                                        </div>
                                        <div class="todo-meta-bottom">
                                            <div class="todo-rating">
                                ...
                                <div class="todo-content">
                                    <h3 class="title"><a href="listing-details.html">Prooffice</a></h3>
                                    <div class="todo-price-status">
                                        <div class="todo-price">$12 - $33</div>
                                        <div class="todo-status">Open Now</div>
                                    </div>
						...
						<div class="row">
							<div class="col-lg-6">
								<a href="#" class="cat-item cat-food">
									<figure class="cat-thumb">
										<img
											src="assets/images/categories/side bs.jpg"
											alt="Thmubnail"
										/>
									</figure>
							...
							<div class="col-lg-3 col-md-6">
								<a href="#" class="cat-item cat-nightlife">
									<figure class="cat-thumb">
										<img
											src="assets/images/categories/eco bs.jpg"
											alt="Thmubnail"
										/>
									</figure>
							...
							<div class="col-lg-3 col-md-6">
								<a href="#" class="cat-item cat-hotel">
									<figure class="cat-thumb">
										<img
											src="assets/images/categories/build website.jpg"
											alt="Thmubnail"
										/>
									</figure>
							...
							<div class="col-lg-3 col-md-6">
								<a href="#" class="cat-item cat-service">
									<figure class="cat-thumb">
										<img
											src="assets/images/categories/logcr.jpg"
											alt="Thmubnail"
										/>
									</figure>
							...
							<div class="col-lg-3 col-md-6">
								<a href="#" class="cat-item cat-sopping">
									<figure class="cat-thumb">
										<img
											src="assets/images/categories/online bs.jpg "
											alt="Thmubnail"
										/>
									</figure>
							...
							<div class="col-lg-6">
								<a href="#" class="cat-item cat-places">
									<figure class="cat-thumb">
										<img
											src="assets/images/categories/dg seo.jpg"
											alt="Thmubnail"
										/>
									</figure>
							...
							<div class="col-lg-4 col-md-6">
								<div class="todo-item">
									<div class="todo-thumbnail-area">
										<figure class="item-thumb">
											<img
												src="assets/images/todo/prf.jpg"
												height="50px"
												alt="Thmubnail"
											/>
										</figure>
